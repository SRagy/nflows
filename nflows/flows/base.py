...
class Flow(Distribution):
    ...
    def __init__(self, transform, distribution, embedding_net=None, only_base_context=False):
        """Constructor.
        ...
        self.only_base_context = only_base_context
    ...
    def _sample(self, num_samples, context, return_noise=False):
        embedded_context = self._embedding_net(context)
        if self._context_used_in_base:
